        ...
        PublicarVideojuegos.setOnClickListener(new View.OnClickListener() {
            ...
            private void SubirNuevaImagen() {
                ...
                uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Toast.makeText(AgregarVideojuegos.this, "Nueva Imagen CargadaT", Toast.LENGTH_SHORT).show();
            ...
            private void SubirImagen() {
                if (RutaArchivoUri != null) {
                    ...
                    storageReference2.putFile(RutaArchivoUri)
                            .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    Videojuegos videojuegos = new Videojuegos(downloadURI.toString(), mNombre, VISTA);
                    ...
                    Toast.makeText(AgregarVideojuegos.this, "DEBE ASIGNAR UNA IMAGEN", Toast.LENGTH_SHORT).show();
                }
            }
